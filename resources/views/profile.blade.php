										...
										<div class="row">
											<div class="col-md-5">
												<div class="profile-info-left">
													<h3 class="user-name m-t-0 mb-0">{{$profile->first_name}} </h3>
													<h6 class="text-muted">{{$profile->department}}</h6>
													<small class="text-muted">{{$profile->position}}</small>
													<div class="staff-id">Employee ID : FT-0001</div>
													<div class="small doj text-muted">Date of Join : {{ \Carbon\Carbon::parse($profile->date_hired)->format('F d, Y')}}</div>
											...
											<div class="col-md-7">
												<ul class="personal-info">
													...
													<li>
														...
														<div class="text"><a href=""><span class="__cf_email__" data-cfemail="89e3e6e1e7ede6ecc9ecf1e8e4f9e5eca7eae6e4">[email&#160;protected]</span></a></div>
													</li>
													<li>
